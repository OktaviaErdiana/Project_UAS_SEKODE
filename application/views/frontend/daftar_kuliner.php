            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb d-flex justify-content-end">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Daftar Wisata Kuliner</li>
                    </ol>
                  </nav>
                <form action="#">
                    <fieldset class="form-daftar-seminar" style="color: white;">
                        <legend class="legend-daftar-seminar mb-md-4">Form Registrasi Tempat Wisata Kuliner</legend>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="jenis_wisata" class="form-control">
                                        ...
                                        <option>Mall</option>
                                        <option>Edukasi dan Rekreasi</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
    ...
    <script>
        function daftar() {
            ...
            if (tmpt_wisata == "" || jenis_wisata == "" || deskripsi_wisata == "" || kontak_person == "" || no_hp == "" || email == "" || alamat_web == "" || alamat_lengkap == "" || latitude == "" || longitude == "" || foto == "") {
                ...
                alert("Berhasil mendaftar wisata kuliner");
